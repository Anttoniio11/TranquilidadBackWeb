...
class MethodPayment extends Model
{
    ...
    protected $allowIncluded = ['bill'];

    // Campos permitidos para filtrado
    protected $allowFilter = ['id', 'medio', 'descripcion', 'importe', 'iva', 'bill_id'];

    // Campos permitidos para ordenamiento
    protected $allowSort = ['id', 'medio', 'descripcion', 'importe', 'iva', 'created_at'];
